...
<nav class="navbar navbar-expand-lg sticky-top">
  <div class="container">
    <div class="container-fluid">
      ...
      <!-- login -->
      <div class="login text-center pb-2 pt-2 d-lg-block d-none" >
        <i class="fa-solid fa-user  "></i>
        <a class="btn rounded-pill main-btn d-block text-light " href="#" >Login</a>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="img-fluid" src="https://cdn.breakers-store.site/wp-content/uploads/elementor/thumbs/spiderman2_header-q8ak1m47sgkdcfrq44cj2wwavqp007admyi0sbidww.png" width="1200px" class="d-block " alt="...">
        </div>
        <div class="carousel-item">
          <img class="img-fluid" src="https://cdn.breakers-store.site/wp-content/uploads/elementor/thumbs/ark_survival_ascended_header-qeq61cnf4dkh9nducrydu4pod84ifneb7be71rtc6o.png" width="1200px" class="d-block " alt="...">
        </div>
        <div class="carousel-item">
          <img class="img-fluid" src="https://cdn.breakers-store.site/wp-content/uploads/elementor/thumbs/batman_arkham_header-qe8ia5lfjkq10abai5rk24v3km78nntdi7pg6kvzlc.png" width="1200px" class="d-block " alt="...">
        </div>
        <div class="carousel-item">
          <img class="img-fluid"  src="https://cdn.breakers-store.site/wp-content/uploads/elementor/thumbs/apex_legends_header-qe8i916ddp6p51y026alkx2a11qggocx0nnkjojx0w.png" width="1200px" class="d-block " alt="...">
        </div>
        <div class="carousel-item">
          <img class="img-fluid" src="https://cdn.breakers-store.site/wp-content/uploads/elementor/thumbs/nightmarket_header-1-qe1wcjrs871xs0c1mmo5amw958zf30yb6edwe574z4.png" width="1200px" class="d-block " alt="...">
        </div>
        <div class="carousel-item">
          <img class="img-fluid" src="https://cdn.breakers-store.site/wp-content/uploads/elementor/thumbs/cod_modern_warfare_3-qd0vbud33w4sv4luyqwydx2p3p7fk448ccx42gj3sg.png" width="1200px" class="d-block " alt="...">
        </div>
      </div>
...
<div class="mostpopular text-light  ">
  <div class="container ">
    <h2 class="font-weight-bold pb-5 ">MOST POPULAR</h2>

    <div class="row">
      <div class="col-lg-4 col-sm-6 g-5">
        <div class="card  steam" style="background-color: #0c1826;">
          ...
          <div class="card-body card-steam ">
            <h5 class="card-title text-uppercase text-center text-light fs-4 ">steam</h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-sm-6  g-5">
        <div class="card " style="background-color: #0c1826;">
          ...
          <div class="card-body card-valorant ">
            <h5 class="card-title text-uppercase text-center text-light fs-4">valorant</h5>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6  g-5">
        <div class="card " style="background-color: #0c1826;">
          ...
          <div class="card-body card-playstaion">
            <h5 class="card-title text-uppercase text-center text-light fs-4">Playstaion STORE</h5>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6  g-5">
        <div class="card " style="background-color: #0c1826;">
          ...
          <div class="card-body card-roblox">
            <h5 class="card-title text-uppercase text-center text-light fs-4">roblox</h5>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6  g-5">
        <div class="card " style="background-color: #0c1826;">
          ...
          <div class="card-body card-pubg">
            <h5 class="card-title text-uppercase text-center text-light fs-4">pubg</h5>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6  g-5">
        <div class="card " style="background-color: #0c1826;">
          ...
          <div class="card-body card-freefire">
            <h5 class="card-title text-uppercase text-center text-light fs-4">Free Fire</h5>
          </div>
        </div>
      </div>
      <!-- Repeat the structure for the remaining cards -->
...
<div class="col-lg-3 col-sm-6  g-5" >
  <div class="card text-light"  style="background-color: #040615 ;  ">
    ...
    <div class="card-body p-2 mt-3" >
      <h5 class="card-title text-uppercase fs-6 font-weight-bold">ARK: Survival Ascended </h5>
...
<div class="col-lg-3 col-sm-6  g-5">
  <div class="card text-light"  style="background-color: #040615; ">
    ...
    <div class="card-body p-2 mt-3" >
      <h5 class="card-title text-uppercase fs-6 font-weight-bold">DOOM 3 PC-Key</h5>
...
<div class="col-lg-3 col-sm-6  g-5">
  <div class="card text-light"  style="background-color: #040615; ">
    ...
    <div class="card-body p-2 mt-3" >
      <h5 class="card-title text-uppercase fs-6  font-weight-bold">BATMAN:ARKHAM COLLECTION STEAM</h5>
...
<div class="col-lg-3 col-sm-6  g-5">
  <div class="card text-light"  style="background-color: #040615; ">
    ...
    <div class="card-body p-2 mt-3" >
      <h5 class="card-title text-uppercase fs-6 font-weight-bold">EA PLAY PRO 1 MONTH PC</h5>
...
<div class="col-lg-3 col-sm-6  g-5">
  <div class="card text-light"  style="background-color: #040615; ">
    ...
    <div class="card-body p-2 mt-3" >
      <h5 class="card-title text-uppercase fs-6 font-weight-bold">2550 RP </h5>
...
<div class="col-lg-3 col-sm-6  g-5">
  <div class="card text-light"  style="background-color: #040615; ">
    ...
    <div class="card-body p-2 mt-3" >
      <h5 class="card-title text-uppercase fs-6 font-weight-bold">WINDOWS 11 PRO RETAIL GLOBAL</h5>
...
<div class="col-lg-3 col-sm-6  g-5">
  <div class="card text-light "  style="background-color: #040615; ">
    ...
    <div class="card-body p-2 mt-3" >
      <h5 class="card-title text-uppercase fs-6 font-weight-bold">1850 VP (TR)</h5>
...
<div class="col-lg-3 col-sm-6  g-5">
  <div class="card text-light "  style="background-color: #040615; ">
    ...
    <div class="card-body p-2 mt-3 " >
      <h5 class="card-title text-uppercase fs-6 font-weight-bold">PLAYSTATION STORE CARD(US)$10</h5>
    ...
    <div class="row ">
      ...
      <div class="col-lg-3 pt-5 mt-4 " >
        <div class="card" style="background-color: #0c1826;" >
          ...
          <ul class="list-group list-group-flush  " > 
            <a href="#" class="btn  main-btn foot-btn  w-100 font-weight-bold  text-center text-light p-3" >Contact us</a>
      ...
      <div class="info ">
        ...
        <div class="text-light" >Developed By Wesellhost
